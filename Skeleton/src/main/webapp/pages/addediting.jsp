...
<form:form method="post" modelAttribute="addUpdateForm" action="updateaddvalue=${currentAdd.id}" id="addUpdateForm" cssClass="form-horizontal"
           autocomplete="off">
    <fieldset>addediting
        ...
        <div class="control-group<c:if test="${not empty titleErrors}"> error</c:if>">
            ...
            <div class="controls">
                <form:input path="title" id="field-title" tabindex="2" maxlength="150" width="350px" placeholder="${currentAdd.title}"/>
        ...
        <div class="control-group<c:if test="${not empty roomDescErrors}"> error</c:if>">
            ...
            <div class="controls">
                <form:textarea path="roomDesc" id="field-roomDesc" rows="6" width="350px" style="resize:vertical;" tabindex="2" maxlength="500" placeholder="${currentAdd.roomDesc}"/>
        ...
        <div class="control-group<c:if test="${not empty numberOfPeopleErrors}"> error</c:if>">
            ...
            <div class="controls">
                <form:input path="numberOfPeople" id="field-numberOfPeople"  tabindex="2" maxlength="150" placeholder="${currentAdd.numberOfPeople}"/>
        ...
        <div class="control-group<c:if test="${not empty roomSizeErrors}"> error</c:if>">
            ...
            <div class="controls">
                <form:input path="roomSize" id="field-roomSize"  tabindex="2" maxlength="150" placeholder="${currentAdd.roomSize}"/> m&sup2;
        ...
        <div class="control-group<c:if test="${not empty roomPriceErrors}"> error</c:if>">
            ...
            <div class="controls">
                <form:input path="roomPrice" id="field-roomPrice"  tabindex="2" maxlength="150" placeholder="${currentAdd.roomPrice}"/> CHF
        ...
        <div class="control-group<c:if test="${not empty fromDateErrors}"> error</c:if>">
            ...
            <div class="controls">
                <form:input path="fromDate" id="field-fromDate" class="span2" tabindex="2" maxlength="150" placeholder="${currentAdd.fromDate }"/>
        ...
        <div class="control-group<c:if test="${not empty toDateErrors}"> error</c:if>">
            ...
            <div class="controls">
                <form:input path="toDate" id="field-toDate" class="span2" tabindex="2" maxlength="150" placeholder="${currentAdd.toDate}"/> or leave empty for undefined
        ...
        <div id="address_left">
	        ...
	        <div class="control-group<c:if test="${not empty streetErrors}"> error</c:if>">
	            ...
	            <div class="controls">
	                <form:input path="street" onblur="codeAddress()" id="field-street" tabindex="2" maxlength="150" placeholder="${currentAdd.address.street}"/>
	        ...
	        <div class="control-group<c:if test="${not empty plzErrors}"> error</c:if>">
	            ...
	            <div class="controls">
	                <form:input path="plz" onblur="codeAddress()" id="field-plz" tabindex="2" maxlength="150" placeholder="${currentAdd.address.plz}"/>
	        ...
	        <div class="control-group<c:if test="${not empty cityErrors}"> error</c:if>">
	            ...
	            <div class="controls">
	                <form:input path="city" onblur="codeAddress()" id="field-city" tabindex="2" maxlength="150" placeholder="${currentAdd.address.city}"/>
